...
export const DEFAULT_SLOT_REELS = 5;
export const DEFAULT_SLOT_ROWS = 3;
export const DEFAULT_SLOT_CELL_SIZE = 220;
export const DEFAULT_SLOT_REEL_GAP = 12;
export const DEFAULT_SLOT_ROW_GAP = 12;
export const DEFAULT_SLOT_DESKTOP_WIDTH = 1920;
export const DEFAULT_SLOT_DESKTOP_HEIGHT = 1080;
export const DEFAULT_SLOT_MOBILE_WIDTH = 1080;
export const DEFAULT_SLOT_MOBILE_HEIGHT = 1920;
export const DEFAULT_PAYTABLE_LINE_BET = 1;
export const DEFAULT_PAYTABLE_MIN_MATCH = 3;
export const DEFAULT_PAYTABLE_PAYLINES = 3;
export const PAYTABLE_THREE_OF_KIND = 3;
export const PAYTABLE_FOUR_OF_KIND = 4;
export const PAYTABLE_BASE_THREE_OF_KIND_MULTIPLIER = 5;
export const PAYTABLE_BASE_FOUR_OF_KIND_MULTIPLIER = 20;
export const PAYTABLE_BASE_FULL_REEL_MULTIPLIER = 80;
export const PAYTABLE_MAX_THREE_OF_KIND_DECAY = 4;
export const PAYTABLE_MAX_FOUR_OF_KIND_DECAY = 10;
export const PAYTABLE_MAX_FULL_REEL_DECAY = 40;
export const PAYTABLE_FULL_REEL_DECAY_STEP = 2;
export const PAYTABLE_MIN_FOUR_OF_KIND_MULTIPLIER = 5;
export const PAYTABLE_MIN_FULL_REEL_MULTIPLIER = 20;
